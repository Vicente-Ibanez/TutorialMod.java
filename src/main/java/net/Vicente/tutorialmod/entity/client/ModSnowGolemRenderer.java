...
@OnlyIn(Dist.CLIENT)
public class ModSnowGolemRenderer extends MobRenderer<SnowGolem, SnowGolemModel<SnowGolem>> {
    private static final ResourceLocation SNOW_GOLEM_LOCATION = new ResourceLocation(TutorialMod.MOD_ID,"textures/entity/snow_golem.png");

    public ModSnowGolemRenderer(EntityRendererProvider.Context p_174393_) {
