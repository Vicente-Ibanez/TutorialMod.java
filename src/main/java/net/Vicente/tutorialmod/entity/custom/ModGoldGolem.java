...
public class ModGoldGolem extends IronGolem {


    public ModGoldGolem(EntityType<? extends IronGolem> p_28834_, Level p_28835_) {
...
//        this.targetSelector.addGoal(2, new HurtByTargetGoal(this));
    ...
    public boolean isInvulnerableTo(DamageSource p_238289_) {
        System.out.println(fireImmune(p_238289_));
        return fireImmune(p_238289_) | super.isInvulnerableTo(p_238289_);
    }

    public boolean fireImmune(DamageSource damageSource) {
