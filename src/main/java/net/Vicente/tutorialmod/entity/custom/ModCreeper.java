...
public class ModCreeper extends Creeper {

    private static final EntityDataAccessor<Integer> DATA_SWELL_DIR = SynchedEntityData.defineId(ModCreeper.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Boolean> DATA_IS_POWERED = SynchedEntityData.defineId(ModCreeper.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> DATA_IS_IGNITED = SynchedEntityData.defineId(ModCreeper.class, EntityDataSerializers.BOOLEAN);
    ...
    public ModCreeper(EntityType<? extends Creeper> p_32278_, Level p_32279_) {
    ...
    @Override
    // ModCreeper can fall further distances
    public int getMaxFallDistance() {
        return this.getTarget() == null ? 3 : 20 + (int)(this.getHealth() - 1.0F);
    }
    ...
    private void explodeCreeper() {
        if (!this.level.isClientSide) {
            float f = this.isPowered() ? 3.0F : 2.0F;
            this.dead = true;
